...
## Stage 2: Door and encounter lifecycle
...
**Success Criteria**: Each included character meets quality and performance budgets; unresolved sourcing explicitly documented.
**Tests**: Type check, production build, regression suite, desktop and narrow viewport review.
**Status**: Not Started
